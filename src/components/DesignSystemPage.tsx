...
const TYPE_SCALE = [
  {
    ...
    spec: "0.75rem · 12px",
    where: "Map attribution, count pills, avatar initials, the mobile corner nav",
  ...
  },
  {
    ...
    spec: "0.875rem · 14px",
    where: "Pill and tab labels, body copy, detail rows, hover-card text",
  ...
  },
  {
    ...
    spec: "1rem · 16px",
    where: "Card titles, hero name, about prose, résumé companies",
