            ...
            <div className="ds-block">
              ...
              <ul className="ds-list">
                ...
                <li data-ds-terms={terms("about introduction profile photo message prompt video teaser circle 112px 64px 240px 256px captions 360ms 160ms 24px 12px deferred reduced motion pip transitions.dev")}>
                  ...
                  The desktop email field caps at 224px by 44px and uses 16px text on every viewport so
                  ...
                  10px by 16px input padding, no outer padding or gap, a white canvas, and the shared hairline ring and control shadow.
                  The 44px send target holds a circular 36px disc. After email confirmation, the contact page’s
                  44px calendar button sits beside the composer with an 8px gap and opens scheduling with that address.
                  ...
                  The message textarea starts 44px high with 16px text and grows with each line up to seven lines
