          ...
          <section id="components" className="ds-section">
            ...
            <div className="ds-block">
              ...
              <p className="ds-caption">
                ...
                The Messages-inspired header centers a 48px circular portrait with <code>corner-shape: round</code> and a subtle <code>--shadow-ring</code>. The plain semibold name sits 6px below it in <code>--text-xs</code>, without a raised badge.
