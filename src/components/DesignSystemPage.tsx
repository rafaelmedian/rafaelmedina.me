            ...
            <div className="ds-block">
              ...
              <ul className="ds-list">
                ...
                <li data-ds-terms={terms("about introduction profile photo message prompt video teaser circle 112px 64px 240px 256px captions 360ms 160ms 24px 12px deferred reduced motion pip transitions.dev")}>
                  ...
                  The 44px send target holds a circular 32px disc and 20px arrow. The microphone is also 20px. After email confirmation, the contact page’s
                  ...
                  The message textarea starts 44px high and grows with each line up to 188px, or 30% of the viewport on short screens, before scrolling; the history gives up the room. The
