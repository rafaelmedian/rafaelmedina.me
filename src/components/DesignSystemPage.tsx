          ...
          <section id="components" className="ds-section">
            ...
            <div className="ds-block">
              ...
              <p className="ds-caption">
                ...
                The Messages-inspired header stays fixed 20px from the viewport top (respecting safe areas), centered over the conversation column independently of message growth. The conversation reserves top space so scrolling messages cannot overlap it. The header centers a 64px circular portrait (48px on short screens) with <code>corner-shape: round</code> and a subtle <code>--shadow-ring</code>. A white <code>--radius-full</code> name pill overlaps its lower edge by 8px, with round corners, <code>--shadow-overlay</code>, and semibold <code>--text-sm</code> lettering.
