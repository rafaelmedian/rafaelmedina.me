...
const TYPE_SCALE = [
  ...
  },
  {
    ...
    spec: "1.125rem · 18px",
    where: "About ledes, writing entry titles, and article prose at every viewport. Editorial writing headings have a scoped 24–40px exception.",
...
const EASINGS = [
  ...
  },
  {
    ...
    duration: "200–360ms",
    use: "Apple Core Animation’s documented default timing curve, scoped to the personal-photo hover fan, hint, flights, captions, and backdrop. Movement builds before easing into place; closing is quicker and captions move with the prints without delay.",
  },
  {
    name: "Popover exit",
