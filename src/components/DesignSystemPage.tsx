      ...
      <div className="ds-app">
        ...
        <div className="ds-work" id="ds-content" tabIndex={-1}>
          ...
          <section id="components" className="ds-section">
            ...
            <div className="ds-block" data-ds-terms={terms("personal photos tile fan arc stack pebble glass globe sphere webgl modal Handlee shadow radius grid masonry toggle layout")}>
