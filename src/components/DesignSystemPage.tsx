          ...
          <section id="components" className="ds-section">
            ...
            <div className="ds-block">
              ...
              <p className="ds-caption">
                ...
                The Messages-inspired header stays fixed 20px from the viewport top (respecting safe areas), centered over the conversation column independently of message growth. The conversation reserves top space so scrolling messages cannot overlap it. The header centers a 64px circular portrait (48px on short screens) with <code>corner-shape: round</code> and a subtle <code>--shadow-ring</code>. The portrait sits in front of the white <code>--radius-full</code> name pill at their 8px overlap, using local <code>z-index: 1</code> inside an isolated identity stack. The pill reads “Rafael” with round corners, a soft <code>--shadow-control-hover</code> without a border ring, and semibold <code>--text-sm</code> lettering. Its 14px chevron uses <code>--muted-soft</code> at 60% opacity.
