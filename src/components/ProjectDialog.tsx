            ...
            <Dialog.Popup className="relative h-[80vh] max-h-[80vh] w-[80vw] max-w-[80vw] overflow-y-auto rounded-[1.25rem] border border-stone-200/90 bg-stone-50 p-6 shadow-2xl outline-none transition duration-200 ease-out data-[ending-style]:translate-y-1 data-[ending-style]:opacity-0 data-[starting-style]:translate-y-1 data-[starting-style]:opacity-0 motion-reduce:transition-none sm:rounded-[1.5rem] sm:p-9">
              ...
              <div className="grid gap-7 sm:grid-cols-[1.05fr_0.95fr] sm:items-start">
                ...
                <div className="space-y-5 pr-7 sm:pr-10">
                  ...
                  <Dialog.Description className="max-w-[34ch] text-pretty text-base leading-relaxed text-stone-700">
                    {card.summary}
                  </Dialog.Description>
                  <p className="max-w-[36ch] text-pretty text-base leading-relaxed text-stone-600">
                    {card.detail}
                  </p>
                  ...
                  <a
                    href={card.ctaHref}
                    {...linkAttributes}
                    className="inline-flex items-center rounded-full bg-[var(--accent)] px-5 py-2.5 text-sm font-semibold text-[var(--ink)] transition-colors duration-150 ease-out hover:bg-[var(--accent-strong)] focus-visible:ring-2 focus-visible:ring-[var(--accent-strong)] motion-reduce:transition-none"
                  >
                    {card.ctaLabel}
                  </a>
                </div>
