...
export function WritingArticle({ writing, titleRef, heading: Heading = "h2", showLikes, onSelectWriting }: WritingArticleProps) {
  ...
  return (
    <article className="writing-reader">
      ...
      {writing.sections && writing.sections.length > 1 ? <ArticleContents sections={writing.sections.map(section => ({ id: sectionSlug(section.heading), heading: section.heading }))} /> : null}
