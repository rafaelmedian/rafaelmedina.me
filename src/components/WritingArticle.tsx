import { ArrowUpRight, Check, ChevronDown, Copy, Link2 } from "lucide-react"
import {
  useEffect,
  useId,
  useLayoutEffect,
...
import type { Writing, WritingAnnotation, WritingCode, WritingImage, WritingSection, WritingTool } from "../data/writings"
