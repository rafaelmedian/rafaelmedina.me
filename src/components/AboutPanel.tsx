    ...
    >
      ...
      <div className="mosaic-about-body">
        ...
        <p>
          ...
          something you can only look at. That habit is most of how I work — build the smallest real
          version, put it in front of people, and let it argue back.
        </p>
        <p>
        ...
        <p className="mosaic-about-closing">
          I&rsquo;m taking on work right now. If you&rsquo;re building something that deserves care,{" "}
          <a
